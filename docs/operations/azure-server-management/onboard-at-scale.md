...
建議為所有伺服器啟用更新管理解決方案。 更新管理免費提供給 Azure Vm 和內部部署伺服器。 如果您透過自動化帳戶啟用更新管理, 則會在工作區中建立[範圍](/azure/automation/automation-onboard-solutions-from-automation-account#scope-configuration)設定。 您必須手動更新範圍, 以包含更新服務所涵蓋的機器。
