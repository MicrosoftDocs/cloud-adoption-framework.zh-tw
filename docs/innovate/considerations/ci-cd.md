...
![實現採用-成熟度模型](../../_images/innovate/empower-adoption-maturity.png)
...
- 在開發初期階段，**持續傳遞**可能更適當。 在持續傳遞中，任何程式碼變更都會自動部署至類似生產的環境。 開發人員、商務決策者和小組中的其他人可以使用此環境來驗證其工作是否已準備好生產。 您也可以使用此方法來測試客戶的假設，而不會影響持續進行的商務活動。
