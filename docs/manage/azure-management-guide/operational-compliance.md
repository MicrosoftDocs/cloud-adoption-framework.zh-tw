...
Azure 自動化的「更新管理」解決方案所管理的電腦，會使用下列設定來執行評估和更新部署：
...
如需詳細資訊，請參閱 [Azure 自動化的「更新管理」解決方案](/azure/automation/update-management/overview)。
