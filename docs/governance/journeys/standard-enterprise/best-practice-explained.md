...
記錄和報告決策會決定您的存放區記錄資料，以及讓 IT 人員知道如何在操作健全狀況上獲得通知的監視和報告工具是結構化的。 在此敘述中，建議使用[雲端原生模式](../../../decision-guides/log-and-report/index.md#cloud-native)* * 來進行記錄和報告。
...
> [改善安全性基準專業領域](./security-baseline-evolution.md)
