...
![具有 azure 帳戶管理員和 Azure AD 全域管理員](../../_images/governance-3-0.png)
...
![Azure 帳戶擁有者會將 * * 工作負載擁有者 * * 新增](../../_images/governance-1-5.png)
...
![* * 工作負載擁有者 * * 已獲指派內建擁有者](../../_images/governance-1-6.png)
...
![* * 工作負載擁有者 * * 會建立](../../_images/governance-1-8.png)
...
最後，既然已建立訂用帳戶，且您的 Azure AD 租用戶已與其相關聯，就可以將**工作負載擁有者**[，新增至具備內建**擁有者**角色](/azure/billing/billing-add-change-azure-subscription-administrator#assign-a-user-as-an-administrator-of-a-subscription)的訂用帳戶。
