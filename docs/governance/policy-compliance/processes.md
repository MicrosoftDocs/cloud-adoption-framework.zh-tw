...
如需原則遵循流程如何融入雲端治理方案的範例，請參閱可採取動作的[治理指南](../journeys/index.md)的公司原則章節。
...
如需有關為您的部署選擇最佳監視模式的指引，請參閱雲端採用架構[記錄和報告決策指南](../../decision-guides/log-and-report/index.md)主題。
...
> [法規合規性](./what-is-regulatory-compliance.md)
