---
title: 開始使用：打造雲端創新團隊
description: 本指南可協助創新團隊瞭解範圍、交付專案，以及他們所負責的功能。
author: JanetCThomas
ms.author: janet
...
# <a name="get-started-build-a-cloud-innovation-team"></a>開始使用：打造雲端創新團隊
...
- 選擇性完成所有必要的訓練。 使用「_標題_的完成」語言，其中（標題）是訓練的連結。
