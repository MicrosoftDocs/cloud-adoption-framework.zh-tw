...
持續反復反覆運算至遷移和就緒指引，以更緊密地配合客戶、Microsoft 合作夥伴和內部 Microsoft 程式的意見反應。
...
| 發行項                                                                                                                 | 說明                                                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [重構登陸區域](../ready/landing-zone/refactor.md)                       | **新文章：** 這篇文章從「現成的研討會」進行繪製，示範從初始範本開始的理論，使用決策樹和重整功能來擴充登陸區域，並移至未來的企業就緒狀態。 |
...
| [改善登陸區域安全性](../ready/considerations/landing-zone-security.md)                       | **新文章：** 此章節中的最佳作法總覽，並將其系結回 TDD 迴圈。 |
