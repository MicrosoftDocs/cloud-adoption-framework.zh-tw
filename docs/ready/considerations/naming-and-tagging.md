...
Azure 架構中心的 [Azure 資源命名慣例](https://docs.microsoft.com/azure/architecture/best-practices/naming-conventions)指南會提供命名慣例的一般建議，並討論命名限制和平台規則。 下列會討論支援企業雲端採用工作的一般指引，並加入詳細建議。
