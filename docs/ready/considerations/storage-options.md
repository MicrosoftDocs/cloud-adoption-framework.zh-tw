...
| 我需要將不在 Windows Server 或 NetApp 的檔案共用移至雲端。 | [Azure 檔案](/azure/storage/files/storage-files-planning) <br><br> [Azure NetApp Files](/azure/azure-netapp-files/azure-netapp-files-introduction) | 通訊協定支援區域可用性效能需求快照和複製功能的價格敏感度 |
