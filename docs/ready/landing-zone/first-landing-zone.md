...
| 登陸區域                                 | 中樞                          | 分支    | 雲端模型 | 技術      |
|----------------------------------------------|------------------------------|----------|-------------|-----------------|--|--|--|
| [CAF 遷移](./migrate-landing-zone.md)     | 需要重構            | 內含 | 僅限 Azure  | Azure Blueprint |
| [CAF Terraform](./terraform-landing-zone.md) | 包含在 VDC 模組中       | 內含 | 多重雲端  | Terraform       |
