...
- 具有高度複雜性和嚴格合規性需求的客戶，可能較適合使用合作夥伴的擴充藍圖，或其中一個[以標準為基礎的藍圖範例](/azure/governance/blueprints/samples/)。
...
|命名和標記標準|N/A|[命名和標記最佳做法](../considerations/name-and-tag.md)         |
