...
下一個控制項會檢查要求不超過 [Azure 訂用帳戶限制](https://docs.microsoft.com/azure/azure-subscription-service-limits)。 例如，每個訂用帳戶的資源群組上限為 980 個。 如果收到的部署額外資源群組要求達到上限，就會遭到拒絕。
...
![財務承諾與訂用帳戶相關聯](../../_images/govern/design/governance-1-21.png)
*圖 13.財務承諾與訂用帳戶相關聯。*
