...
客戶在與該公司互動時需要更好的經驗。 目前的經驗導致市場削弱，並導致面板能夠雇用數位長（cdo）。 Cdo 與行銷和銷售合作，來推動數位轉型，以增強體驗。 此外，有一些業務單位最近聘請資料科學家提供資料，並透過學習和預測來提升許多人工經驗。 IT 一直在盡力支援這些工作。 有「影子 IT」活動發生在所需的治理和安全性控制範圍外。
